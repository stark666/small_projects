...
#添加首页标题关注 20171231
#网页改版，修改网址选择部分 url_select 20180302
#网页改版，修改网址选择部分 star_store daily_check 20180303
...
def log(username='472217937@qq.com',password='*********'):  
...
def url_select(session):
	...
	for i in soup.findAll(style="cursor: pointer;",target="_blank"):     #改版后,只回复普通帖子，若要回复重要帖子需修改style
		post_data={}
...
def friends_help():
	friends=[['18362966231','********'],['13600712532','***********'],
	['18362960752','*******'],['rogerism@163.com','*******'],
	['stark666666@outlook.com','*******']]
